...
// // // exports.Authorisation = (userId,transactionstring) => {
...
// //             let result= await  Authorisation.find({status:"initiated"})
// //             //  .then(result =>{
// //             for(let i=0;i<result.length;i++){
// //                 var str=(JSON.stringify(result[i]._doc. Authorisation));
// //                 console.log("str=========================>",str);
...
// //         });
// //     data.save()
// //              resolve(patientData.remove({_userId:result[i].userId}))
// //            }
...
// //             });
// //          data.save()
// //     resolve( Authorisation.remove({_userId:result[i].userId}))
...
// bcSdk.savetransaction({ TransactionDetails: data})
// console.log("ledger");
//         if(HospitalName=="Apollo"){
//             var string=JSON.stringify(transferObj)
//             console.log("string in apollo========================>",string)
